 ...
 * @author sgano
 */
public class HelpInformationJFrame extends javax.swing.JFrame
{

    /**
     * Creates new form HelpInformationJFrame
     */
    public HelpInformationJFrame()
    {
        initComponents();
        
        // don't kill the app, just close this window
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(HelpInformationJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new HelpInformationJFrame().setVisible(true);
            }
        });
    }
